...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <sec:ifAnyGranted roles="ROLE_POSTULANTE">
                    <li><a class="list" href="/certificacion/index/${per}"> <g:message code="default.list.label" args="[entityName]" /></a></li>
        ...
        <div id="show-certificacion" class="content scaffold-show" role="main">
            ...
            <f:display bean="certificacion" />
            <g:form resource="${this.certificacion}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.certificacion}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
