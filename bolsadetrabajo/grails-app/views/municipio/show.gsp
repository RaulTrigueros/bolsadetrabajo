...
<html>
    ...
    <body>
        ...
        <div id="show-municipio" class="content scaffold-show" role="main">
            ...
            <f:display bean="municipio" />
            <g:form resource="${this.municipio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.municipio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
