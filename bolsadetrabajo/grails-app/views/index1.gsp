                    ...
                    <div class="col-xl-6">
                        ...
                        <form>
                            <div class="input-group input-group-lg">
                                ...
                                <button class="btn btn-primary" id="button-submit" type="button">Acceder!</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 h-100 text-center text-lg-start my-auto">
                      <p class="text-muted small mb-4 mb-lg-0">&copy; BADMASTERS 2021. Todos los Derechos Reservados.</p>
                    </div>
