...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <sec:ifAnyGranted roles="ROLE_POSTULANTE">
                    <li><a class="list" href="/telefono/index/${per}"> <g:message code="default.list.label" args="[entityName]" /></a></li>
               </sec:ifAnyGranted>
            </ul>
        </div>
        <div id="show-telefono" class="content scaffold-show" role="main">
            ...
            <f:display bean="telefono" />
            <g:form resource="${this.telefono}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.telefono}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
